...
export const PROJECT_DESCRIPTOR_STYLE_STUDIO: TProjectDesciptorFn = (dico: Dictionary) => ({
	...
	thumbnail: { ratio: "DEFAULT", src: "/assets/thumbnails/workflow.webp" },
	preview: "/assets/thumbnails/workflow.webp",
	banner: {
		src: "/assets/banners/workflow.webp",
		alt: "Style Studio plugin snapshot displayed on a macbook mockup.",
...
export const PROJECT_DESCRIPTOR_EMOTIONAL_MAPPER: TProjectDesciptorFn = (dico: Dictionary) => ({
	...
	thumbnail: { ratio: "DEFAULT", src: "/assets/thumbnails/pulse.webp" },
	preview: "/assets/thumbnails/pulse.webp",
	banner: {
		src: "/assets/banners/pulse.webp",
		alt: "A software snapshot displayed on a monitor with 2 iphones mockup next to it.",
...
export const PROJECT_DESCRIPTOR_AZUSA: TProjectDesciptorFn = (dico: Dictionary) => ({
	...
	thumbnail: { ratio: "DEFAULT", src: "/assets/thumbnails/azusa.webp" },
	preview: "/assets/thumbnails/azusa.webp",
	banner: {
		src: "/assets/banners/azusa.webp",
		alt: "Video game snapshot with 3D characters in front.",
...
export const PROJECT_DESCRIPTOR_USABILITY: TProjectDesciptorFn = (dico: Dictionary) => ({
	...
	alt: "Video game snapshot with 3D characters in front.",
	thumbnail: { ratio: "DEFAULT", src: "/assets/thumbnails/usability.webp" },
	preview: "/assets/thumbnails/usability.webp",
	banner: {
		src: "/assets/banners/usability.webp",
		alt: "Video game snapshot with 3D characters in front.",
...
export const PROJECT_DESCRIPTOR_WEBGPU: TProjectDesciptorFn = (dico: Dictionary) => ({
	...
	thumbnail: { ratio: "DEFAULT", src: "/assets/thumbnails/webgpu.webp" },
	preview: "/assets/thumbnails/webgpu.webp",
	banner: {
		src: "/assets/banners/webgpu.webp",
		alt: "A macbook mockup with a 3D engine interface displayed on the screen.",
...
export const PROJECT_DESCRIPTOR_ANIMAL: TProjectDesciptorFn = (dico: Dictionary) => ({
	...
	thumbnail: {
		ratio: "WIDE",
		src: "/assets/thumbnails/animal.webp",
		small: "/assets/thumbnails/animal-sm.webp",
	},
	preview: "/assets/thumbnails/animal-sm.webp",
	banner: {
		src: "/assets/banners/animal.webp",
		alt: "Video snapshots layed out next to 3D characters standing close to one another.",
