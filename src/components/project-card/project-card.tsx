...
import { IThumbnail } from "@/types/project";
import { TABLET_WIDTH, THUMBNAIL_HEIGHT, THUMBNAIL_WIDTH, THUMBNAIL_WIDTH_WIDE } from "@/lib/constants";
import { useDictionary } from "@/i18n/Context";
import CornerFrame from "@/components/corner-frame/corner-frame";
...
export default function ProjectCard({ headline, subtitle, thumbnail, alt, href, size = "DEFAULT" }: IProjectCard) {
	...
	const Name = size === "DEFAULT" ? Text.H4 : Text.H5;
	const Desc = size === "DEFAULT" ? Text.Subtitle1 : Text.Body;
